(function () {
  ...
  window.setInterval(function () {
    $(".background").css(
      "background-image",
      "url(./assets/img/img" + curImgId + ".jpg)"
    );
    resetAnimation();
...
ScrollReveal().reveal(
  ".slide-heading, .btn-contain, .service-head, .banner-mark, .footer-left",
  {
    delay: 200,
...
ScrollReveal().reveal(
  ".about-title, .slide-desc, .partner-contain, .footer-right",
  {
    delay: 200,
    easing: "cubic-bezier(1, 1, 0.9, 1)",
    origin: "right",
...
ScrollReveal().reveal(
  ".abtract-container, .about-mark, .banner-right-inner, .contact-body, .contact-head-heading",
  {
    delay: 200,
    easing: "cubic-bezier(1, 1, 0.9, 1)",
    origin: "bottom",
